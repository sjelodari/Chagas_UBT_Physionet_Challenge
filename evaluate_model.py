...
#
#   python evaluate_model.py -d data -o outputs -s local_scores_o3.csv
#
# where 'data' is a folder containing WFDB files with the labels for the data, 'outputs' is a folder containing WFDB files with
# outputs from your model, and 'local_scores_o3.csv' (optional) is a collection of scores for the model outputs.
#
